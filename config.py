...
_C.TRAIN.EPOCHS = 50
# _C.TRAIN.TASK = 'bvp'
_C.TRAIN.USE_PRETRAINED_WEIGHTS = False 
...
_C.VALID.DATA.DATASET_TYPE = 'face'
...
_C.TEST.DATA.INFO.STATE = [1]
_C.TEST.DATA.INFO.TYPE = [1]
...
_C.TEST.DATA.DATASET_TYPE = 'face'
_C.TEST.DATA.FS = 0
...
_C.MODEL.MultiPhysNet = CN()
_C.MODEL.MultiPhysNet.FRAME_NUM = 64
# -----------------------------------------------------------------------------
# Specific parameters for FactorizePhys parameters
# -----------------------------------------------------------------------------
_C.MODEL.FactorizePhys = CN()
_C.MODEL.FactorizePhys.FRAME_NUM = 128
...
# -----------------------------------------------------------------------------
_C.MODEL.My2 = CN()
_C.MODEL.My2.FRAME_NUM = 128
_C.MODEL.My2.CHANNELS = 3
_C.MODEL.My2.TYPE = "Standard"
_C.MODEL.My2.MD_FSAM = False
_C.MODEL.My2.MD_TYPE = 'NMF'
_C.MODEL.My2.MD_TRANSFORM = 'T_KAB'
_C.MODEL.My2.MD_R = 1
_C.MODEL.My2.MD_S = 1
_C.MODEL.My2.MD_STEPS = 4
_C.MODEL.My2.MD_INFERENCE = True
_C.MODEL.My2.MD_RESIDUAL = True
_C.MODEL.My2.MD_GAMMA = 0.8
# -----------------------------------------------------------------------------
# 新增 My 模型參數
# -----------------------------------------------------------------------------
_C.MODEL.My = CN()
_C.MODEL.My.FRAME_NUM = 128  # 幀數，與 MultiPhysNet 一致，可調整
